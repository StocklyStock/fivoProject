...
from .views import RegisterView, VerifyCodeView, LoginView, CurrentUserView, user_list, delete_user, update_user, health_check,UpdateUserView,DeleteUserView,ChangePasswordView
